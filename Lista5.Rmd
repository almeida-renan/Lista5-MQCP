...
Hipótese nula (*H~0~*): As distribuições das variáveis são independentes, isto é, não existe associação entre sexo e identificação partidária;

Hipótese alternativa (*H~1~*): Há dependência entre as distribuições das variáveis, isto é, existe associação entre sexo e identificação partidária.
