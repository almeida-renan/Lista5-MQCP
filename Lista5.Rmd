...
Vamos olhar as relações entre o gênero dos eleitores e a identificação partidária.
...
Portanto, considerando um nível de significância de 1%, encontrarmos um p-valor menor que 0,01. Assim, podemos rejeitar a hipótese nula e considerar que as variáveis possuem alguma relação, não sendo independentes. 

## 6. Gráficos
Também podemos observar graficamente o teste. Nesse caso, quanto menor for o p-valor, mais "distante" estamos da hipótese nula. 
